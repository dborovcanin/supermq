...
// NewAuthServiceClient creates mock of users service.
func NewAuthServiceClient(users map[string]string, authzDB map[string][]SubjectSet) mainflux.AuthServiceClient {
