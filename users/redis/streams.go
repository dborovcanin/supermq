...
<<<<<<<< HEAD:users/clients/events/streams.go
	"github.com/mainflux/mainflux/pkg/events"
	"github.com/mainflux/mainflux/pkg/events/redis"
	"github.com/mainflux/mainflux/users/clients"
========
	"github.com/mainflux/mainflux/users"
>>>>>>>> 9492132bb (Return Auth service):users/redis/streams.go
...
func NewEventStoreMiddleware(ctx context.Context, svc clients.Service, url string) (clients.Service, error) {
	...
	if err != nil {
		return nil, err
========
func NewEventStoreMiddleware(ctx context.Context, svc users.Service, client *redis.Client) users.Service {
	es := eventStore{
		svc:       svc,
		client:    client,
