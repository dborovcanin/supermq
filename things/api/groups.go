...
func groupsHandler(svc groups.Service, r *chi.Mux, logger logger.Logger) http.Handler {
	...
	r.Route("/channels", func(r chi.Router) {
		r.Post("/channels", otelhttp.NewHandler(kithttp.NewServer(
		...
		r.Get("/{chanID}", otelhttp.NewHandler(kithttp.NewServer(
		...
		r.Put("/{chanID}", otelhttp.NewHandler(kithttp.NewServer(
		...
		r.Post("/{chanID}/enable", otelhttp.NewHandler(kithttp.NewServer(
		...
		r.Post("/{chanID}/disable", otelhttp.NewHandler(kithttp.NewServer(
