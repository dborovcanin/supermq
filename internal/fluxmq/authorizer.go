...
var _ broker.Authorizer = (*Authorizer)(nil)

// Authorizer uses SuperMQ Channels gRPC Authorize RPC for topic-level decisions.
type Authorizer struct {
	client     grpcChannelsV1.ChannelsServiceClient
	clientType string
...
// NewAuthorizer creates a SuperMQ-backed topic authorizer for FluxMQ.
func NewAuthorizer(conn *grpc.ClientConn, clientType string, logger *slog.Logger) *Authorizer {
