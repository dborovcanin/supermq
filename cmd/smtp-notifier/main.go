...
func newService(db *sqlx.DB, tracer trace.Tracer, auth mainflux.UsersAuthServiceClient, c config, ec email.Config, logger mflog.Logger) (notifiers.Service, error) {
