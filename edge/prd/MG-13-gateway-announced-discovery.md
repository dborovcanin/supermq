...
No transport addressing in the payload — per
[spec §8 A3](../architecture.md#8-decision-record) the gateway keeps the serial → local address
map to itself. It reports only *what it found*, not how it reaches it.
